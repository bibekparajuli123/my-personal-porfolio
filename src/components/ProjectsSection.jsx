...
const projects = [
  ...
  {
    id: 2,
    title: "Banking System using OOP principles and JDBC",
    description:
      "OOP principles and JDBC to connect with MySQL. It supports user registration, login, debit/credit, transfers, and balance checks, demonstrating core Java and database integration",
